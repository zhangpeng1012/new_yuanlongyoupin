function page_ctrl(data_obj) {
  ...
  function page_even() {
    ...
    var append_html='<button class="prev_page"><i class="icon iconfont">&#xe606;</i></button>';
    ...
    append_html+='<button class="next_page"><i class="icon iconfont">&#xe610;</i></button><span class="page_total"> 跳转</span><input class="input_page_num" type="text" value="'+inp_val+'"><span class="page_text">/'+total_page+' 页</span><button class="to_page_num">确定</button>';
